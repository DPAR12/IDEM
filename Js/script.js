...
function showDedicationText() { //seguidores
  ...
  if (!text) {
  text = `Para mi Paty:\n\n Tu mirada, Tu sonrisa, tu voz, tu forma de ser… todo en ti me hace sentir en casa.\n\nGracias por acompañarme en cada paso, por entenderme incluso en silencio, y por llenar mis días de amor.\n\nTe amo más de lo que las palabras pueden expresar.\n\n A pesar de los momentos dificiles y los malos ratos.. El amor sigue demostrando que va mas allá de lo que nosotros creemos.  `;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Dam";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2023-04-15T00:00:00');
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2028-04-15T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Nuestra proxima pelea: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
